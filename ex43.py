...
class CentralCorridor(Scene):
	...
	def enter(self):
		...
		if action == "shoot!":
			...
			print "makes him fly into an insane rage and blast you repeatedly in the face and"
			...
			print "The Gothon stops, tries not to laugh, then busts out laughing and can’t hold his weapon."
